...
#ifndef IOT_PROJECT_INTERFACES__SRV__DETAIL__TASK_ASSIGNMENT__FUNCTIONS_H_
#define IOT_PROJECT_INTERFACES__SRV__DETAIL__TASK_ASSIGNMENT__FUNCTIONS_H_
 ...
 * calls
 * iot_project_interfaces__srv__TaskAssignment_Request__init().
...
/**
 * It calls
 * iot_project_interfaces__srv__TaskAssignment_Request__fini()
 ...
 * iot_project_interfaces__srv__TaskAssignment_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * iot_project_interfaces__srv__TaskAssignment_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * iot_project_interfaces__srv__TaskAssignment_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_iot_project_interfaces
...
/**
 * It calls
 * iot_project_interfaces__srv__TaskAssignment_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_iot_project_interfaces
...
/**
 * It allocates the memory for the array and calls
 * iot_project_interfaces__srv__TaskAssignment_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_iot_project_interfaces
...
/**
 * It calls
 * iot_project_interfaces__srv__TaskAssignment_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IOT_PROJECT_INTERFACES__SRV__DETAIL__TASK_ASSIGNMENT__FUNCTIONS_H_
