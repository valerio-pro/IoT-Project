...
#include "iot_project_interfaces/msg/detail/targets_time_left__rosidl_typesupport_fastrtps_c.h"
...
using _TargetsTimeLeft__ros_msg_type = iot_project_interfaces__msg__TargetsTimeLeft;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TargetsTimeLeft__ros_msg_type * ros_message = static_cast<const _TargetsTimeLeft__ros_msg_type *>(untyped_ros_message);
  // Field name: times
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TargetsTimeLeft__ros_msg_type * ros_message = static_cast<_TargetsTimeLeft__ros_msg_type *>(untyped_ros_message);
  // Field name: times
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_iot_project_interfaces__msg__TargetsTimeLeft(
  const void * untyped_ros_message,
...
static uint32_t _TargetsTimeLeft__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_iot_project_interfaces__msg__TargetsTimeLeft(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_iot_project_interfaces
size_t max_serialized_size_iot_project_interfaces__msg__TargetsTimeLeft(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _TargetsTimeLeft__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_iot_project_interfaces__msg__TargetsTimeLeft(
...
static message_type_support_callbacks_t __callbacks_TargetsTimeLeft = {
...
static rosidl_message_type_support_t _TargetsTimeLeft__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TargetsTimeLeft,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, iot_project_interfaces, msg, TargetsTimeLeft)() {
  return &_TargetsTimeLeft__type_support;
}
